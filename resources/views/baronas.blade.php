...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light" id="mainNbaron">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="{{url('native/img/baronas/logo-evolty2.png')}}" style="height: 50px;"></a>
    ...
    <header class="cd-section" id="section02">
      <div class="container" style="margin-top: 7vh;min-height: 100vh">
        ...
        <div class="container text-center" style="margin-top: 10vh">
          <div class="row">
            <div class="col-sm-4">
              <img src="{{url('native/img/baronas/timeline-1.png')}}" class="img-fluid" style="height: 300px">
      ...
      <header id="section06" class="d-flex cd-section text-center">
        <div class="container" style="min-height: 100vh">
          ...
          <div class="row" style="margin-top: 5vh">
            <div class="col-sm-3">
              <img src="{{url('native/img/baronas/galeri-1.png')}}" class="img-fluid" style="height: 150px;">
            </div>
            <div class="col-sm-3">
              <img src="{{url('native/img/baronas/galeri-2.png')}}" class="img-fluid" style="height: 150px;">
            </div>
            <div class="col-sm-3">
              <img src="{{url('native/img/baronas/galeri-3.png')}}" class="img-fluid" style="height: 150px;">
            </div>
            <div class="col-sm-3">
              <img src="{{url('native/img/baronas/galeri-4.png')}}" class="img-fluid" style="height: 150px;">
            </div>
          </div>
          <div class="row" style="margin-top: 10vh">
            <div class="col-sm-3">
              <img src="{{url('native/img/baronas/galeri-5.png')}}" class="img-fluid" style="height: 150px;">
            </div>
            <div class="col-sm-3">
              <img src="{{url('native/img/baronas/galeri-6.png')}}" class="img-fluid" style="height: 150px;">
            </div>
            <div class="col-sm-3">
              <img src="{{url('native/img/baronas/galeri-7.png')}}" class="img-fluid" style="height: 150px;">
            </div>
            <div class="col-sm-3">
