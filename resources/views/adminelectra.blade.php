              ...
              {{csrf_field()}}
                <div class="modal-body" style="overflow-y: auto; max-height: 400px">
                  <div class="input-group">
                    ...
                    <input id="no_peserta" type="text" class="form-control col-lg-8" name="no_peserta" placeholder="Nomor Peserta" value="{{ old('no_peserta') }}" required>
                    @else
                    <input id="no_peserta" type="text" class="form-control col-lg-8" name="no_peserta" placeholder="Nomor Peserta" value="{{$user->no_peserta}}" required>
                    @endif
                  </div>
                  <br>
                  <div class="input-group">
                  ...
                  <div class="input-group">
                    ...
                    <select id="kelasketua" name="kelasketua" placeholder="Kelas Ketua" class="form-control">
                  ...
                  <div class="input-group">
                    ...
                    <select id="kelasanggota1" name="kelasanggota1" placeholder="Kelas Anggota 1" class="form-control">
                  ...
                  <div class="input-group">
                    ...
                    <select id="kelasanggota2" name="kelasanggota2" placeholder="Kelas Anggota 2" class="form-control">
                        <option>Pilih Kelas Anggota 2</option>
                        <option value="10" @if (old('10') == "10") selected @endif>10</option>
                        <option value="11" @if (old('11') == "11") selected @endif>11</option>
                        <option value="12" @if (old('12') == "12") selected @endif>12</option>
