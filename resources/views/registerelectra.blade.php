    ...
    <header class="masthead text-center text-white d-flex align-items-center">
      ...
      <div class="row">
        ...
        <div class="col-sm-6" style="z-index: 1;">
          <img style="margin-top: 5em;height: 150px;margin-bottom: 2em; margin-right:5em;" src="{{url('native/img/baronas/logo-evolty3.png')}}">
           ...
           <form class="col-sm-12" method="POST" action="{{ route('register')}}" enctype="multipart/form-data">
            {{ csrf_field()}}
                ...
                <div class="form-group{{ $errors->has('namatim') ? ' has-error' : '' }}">
                    <div class="input-group">
                        <!-- <span class="input-group-addon" id="addon_username"><i class="fa fa-envelope fa-fw"></i></span> -->
                        <input id="namatim" type="text" class="form-control" name="namatim" placeholder="Nama Tim" value="{{ old('namatim') }}"  >
                ...
                <div class="form-group{{ $errors->has('asalsekolah') ? ' has-error' : '' }}">
                    <div class="input-group">
                        <!-- <span class="input-group-addon" id="addon_username"><i class="fa fa-envelope fa-fw"></i></span> -->
                        <input id="asalsekolah" type="text" class="form-control" name="asalsekolah" placeholder="Asal Sekolah" value="{{ old('asalsekolah') }}"  >
                ...
                <div class="form-group{{ $errors->has('alamatsekolah') ? ' has-error' : '' }}">
                    <div class="input-group">
                        <!-- <span class="input-group-addon" id="addon_username"><i class="fa fa-envelope fa-fw"></i></span> -->
                        <input id="alamatsekolah" type="text" class="form-control" name="alamatsekolah" placeholder="Alamat Sekolah" value="{{ old('alamatsekolah') }}" >
                ...
                <div class="form-group{{ $errors->has('namaketua') ? ' has-error' : '' }}">
                    <div class="input-group">
                        <!-- <span class="input-group-addon" id="addon_username"><i class="fa fa-envelope fa-fw"></i></span> -->
                        <input id="namaketua" type="text" class="form-control" name="namaketua" placeholder="Nama Ketua" value="{{ old('namaketua') }}">
                ...
                <div class="form-group{{ $errors->has('namaanggota1') ? ' has-error' : '' }}">
                    <div class="input-group">
                        <!-- <span class="input-group-addon" id="addon_username"><i class="fa fa-envelope fa-fw"></i></span> -->
                        <input id="namaanggota1" type="text" class="form-control" name="namaanggota1" placeholder="Nama Anggota 1" value="{{ old('namaanggota1') }}">
                ...
                <div class="form-group{{ $errors->has('namaanggota2') ? ' has-error' : '' }}">
                    <div class="input-group">
                        <!-- <span class="input-group-addon" id="addon_username"><i class="fa fa-envelope fa-fw"></i></span> -->
                        <input id="namaanggota2" type="text" class="form-control" name="namaanggota2" placeholder="Nama Anggota 2" value="{{ old('namaanggota2') }}">
